    ...
    <div class="row">
        <div class="col-lg-12 offset-0">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form action="{{route('advertise.update',$advInfo->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="title" class="form-control" value="{{$advInfo->title}}" placeholder="Enter Title Here" aria-label="title">
                        </div>
                        ...
                        <!-- <input type="text" name="details" value="{{old('short_details')}}"  class="form-control" placeholder="Enter Product details" aria-label="details">-->
                            <textarea name="short_details" required class="form-control" id="Advertise_short_description" cols="80" rows="5">{{$advInfo->short_details}}</textarea>
                        </div>
                        <br>
                        ...
                        <div class="col-md-12">
                            ...
                            <div  style="background:transparent; display: inline-block; padding-bottom: 50px; padding-top:50px; padding:5%;" class="col-md-3">
                                ...
                                <img src="{{URL::asset($advInfo->image)}}" alt="" width="85%">
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="form-footer pt-5 border-top text-center">
                            <button type="submit" class="btn btn-primary btn-default">Update Advertise</button>
                        </div>
