                    ...
                    <div class="row details_row">
                        ...
                        <div class="col-lg-6">
                            <div class="details_image">
                                <div class="details_image_large"><a href="{{asset($productInfo->featured_image)}}" data-fancybox data-caption="Product Image"><img src="{{asset($productInfo->featured_image)}}" alt=""></a><div class="product_extra product_new"><a href="#">New</a></div></div>
                                <div class="details_image_thumbnails d-flex flex-row align-items-start">
                                    @if(count($productInfo->product_image))
                                        @foreach($productInfo->product_image as $image)
                                            <div class="details_image_thumbnail active" data-image="{{URL::asset($image->file_path)}}"> <a href="{{asset($image->file_path)}}" data-fancybox data-caption="Toledo X8 Blue Color"> <img src="{{URL::asset($image->file_path)}}" alt=""> </a></div>
                        ...
                        <div class="col-lg-6">
                            <div class="details_content">
                                <div class="details_name">{{$productInfo->name}}</div>
